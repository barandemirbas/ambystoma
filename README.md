...
### MacOS M1
```sh
curl -LJO https://github.com/barandemirbas/ambystoma/releases/download/v1.0.0/ambystoma-mac-arm64 && mv ambystoma-mac-arm64 /usr/local/bin/ambystoma && chmod +x /usr/local/bin/ambystoma
```
